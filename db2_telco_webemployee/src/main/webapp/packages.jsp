...
<div class="columns is-centered">
    <div class="column is-5 packages">
        ...
        <p class="subtitle is-5">Click on a service package to modify it</p>

        <button type="submit" class="button is-primary" onclick="location.href = '${pageContext.request.contextPath}/configure';">
            <span class="icon">
                        ...
                        <div class="modal" id="modal-js-${servicePackage.getID()}">
                            ...
                            <div class="modal-card">
                                ...
                                <footer class="modal-card-foot">
                                    <form method="get" action="${pageContext.request.contextPath}/configure">
                                        <input type="hidden" value="${servicePackage.getID()}" name="IDPackage"/>
